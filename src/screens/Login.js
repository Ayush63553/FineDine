...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (json.success) {
      ...
      localStorage.setItem("Xcord",json.cords[0])
      localStorage.setItem("Ycord",json.cords[1])
      // global.Xcord=json.cords[0];
      // global.Ycord=json.cords[1];
      // console.log(global.Xcord,",",global.Ycord);
      navigate("/home");
    }
      ...
      <div className='container'>
        <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
          <div className="m-3">
            ...
            <div id="emailHelp" className="form-text">Your Email will be secure</div>
          </div>
          <div className="m-3">
