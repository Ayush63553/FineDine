    ...
    <div>
      ...
      <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
        ...
        <div className="card-body">
          ...
          <p className="card-text">{haversine(a, b)} meters from home</p>
          ...
          {/* <div className="card-title">{props.cords[0]}</div> */}
          <hr></hr>
          <button className={`btn btn-success justify-center ms-2 `} onClick={handleAddToCart}>Book Seats</button>
